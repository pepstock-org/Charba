 ...
 */
public final class JsObjectArrayList<E extends GenericJavaScriptObject> implements List<E> {
	 ...
	 */
	JsObjectArrayList(JsArrayObjectImpl array) {
	...
	public String toString() {
		return "ObjectArrayList [array=" + array.toJSON() + "]";
	}
