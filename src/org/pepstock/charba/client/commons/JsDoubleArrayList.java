 ...
 */
public final class JsDoubleArrayList implements List<Double> {
	
	// delegated array to store objects
	private final JsArrayDoubleImpl array;
	...
	public Iterator<Double> iterator() {
		return new IteratorImpl<Double>(this);
	}
	...
	public ListIterator<Double> listIterator() {
		return new ListIteratorImpl<Double>(0, this);
	}
	...
	public ListIterator<Double> listIterator(int index) {
        ...
        return new ListIteratorImpl<Double>(index, this);
	}
	...
	public String toString() {
		return "DoubleArrayList [array=" + array.toJSON() + "]";
	}
