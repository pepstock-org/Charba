 ...
 */
public final class JsObjectContainerArrayList<E extends JavaScriptObjectContainer> extends AbstractList<E> {
	
	// delegated array to store objects
	private final JsArrayObjectImpl array;
	 ...
	 */
	JsObjectContainerArrayList(JsArrayObjectImpl array) {
		// if null, creates a new JS array
		if (array == null){
			this.array = (JsArrayObjectImpl)JsArrayObjectImpl.createArray().cast();
		} else {
	 ...
	 */
	public JsObjectContainerArrayList() {
		this(null);
	}

	/* (non-Javadoc)
	 * @see org.pepstock.charba.client.commons.AbstractList#getJsArray()
	 */
	@Override
	JavaScriptObject getJsArray() {
		return array;
	}
	...
	public boolean add(E e) {
		...
		if (added){
			// adds to JS array
			array.push(e.getJavaScriptObject());
		}
		return added;
	}
	...
	public E set(int index, E element) {
		...
		if (checkRange(index)){
			...
			// sets on JS array
			array.set(index, element.getJavaScriptObject());
			// returns old value
			return old;
		}		
		return null;
	...
	public void add(int index, E element) {
		...
		array.insertAt(index, element.getJavaScriptObject());
	}
	...
	public String toString() {
		return "ObjectContainerArrayList [array=" + array.toJSON() + "]";
	}
