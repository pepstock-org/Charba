...
public final class ArrayImage extends Array {
	 ...
	 * 
	 * @param items list of images to load in the new java script array.
	 ...
	 */
	native ArrayImage slice(int start, int end);
	 ...
	 */
	native ArrayImage splice(int start);
	 ...
	 *         If no elements are removed, an empty array is returned.
	 */
	native ArrayImage splice(int start, int deleteCounts);
