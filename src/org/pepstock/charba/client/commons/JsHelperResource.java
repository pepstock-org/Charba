...
public final class JsHelperResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"CharbaJsItemsHelper.getLabelForValue=function $CharbaJsItemsHelper$getLabelForValue$($obj$$,$value$$){return $obj$$.getLabelForValue($value$$)};CharbaJsItemsHelper.getPixelForValue=function $CharbaJsItemsHelper$getPixelForValue$($obj$$,$value$$,$index$$){return $obj$$.getPixelForValue($value$$,$index$$)};CharbaJsItemsHelper.getValueForPixel=function $CharbaJsItemsHelper$getValueForPixel$($obj$$,$pixel$$){return $obj$$.getValueForPixel($pixel$$)};CharbaJsItemsHelper.getBaseValue=function $CharbaJsItemsHelper$getBaseValue$($obj$$){return $obj$$.getBaseValue()};",
		"CharbaJsItemsHelper.getBasePixel=function $CharbaJsItemsHelper$getBasePixel$($obj$$){return $obj$$.getBasePixel()};function CharbaJsDateAdapterHelper(){}CharbaJsDateAdapterHelper.create=function $CharbaJsDateAdapterHelper$create$($options$$){return new Chart._adapters._date($options$$)};"
	};
