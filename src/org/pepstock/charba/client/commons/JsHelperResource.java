...
public final class JsHelperResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"CharbaJsHelper.newCallbackProxy=function $CharbaJsHelper$newCallbackProxy$(){var $obj$$={callback:null,proxy:function(){if(null!=$obj$$.callback&&\"function\"===typeof $obj$$.callback){var $args_result$$=Array.of(this).concat(Array.prototype.slice.call(arguments));$args_result$$=$obj$$.callback.apply(this,$args_result$$);if(null!==$args_result$$&&void 0!==$args_result$$)return $args_result$$}}};return $obj$$};",
		"CharbaJsHelper.isCanvasPattern=function $CharbaJsHelper$isCanvasPattern$($obj$$,$key$$){return $obj$$ instanceof CanvasPattern};CharbaJsHelper.isCanvasGradient=function $CharbaJsHelper$isCanvasGradient$($obj$$,$key$$){return $obj$$ instanceof CanvasGradient};function CharbaJsControllerHelper(){}CharbaJsControllerHelper.register=function $CharbaJsControllerHelper$register$($controllerType$$,$instance$$){Chart.controllers[$controllerType$$]=Chart.DatasetController.extend($instance$$)};",
