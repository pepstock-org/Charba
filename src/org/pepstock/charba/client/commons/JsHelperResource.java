...
public final class JsHelperResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
			...
			"CharbaJsHelper.isCanvasPattern=function $CharbaJsHelper$isCanvasPattern$($obj$$){return $obj$$ instanceof CanvasPattern};CharbaJsHelper.isCanvasGradient=function $CharbaJsHelper$isCanvasGradient$($obj$$){return $obj$$ instanceof CanvasGradient};function CharbaJsPluginHelper(){}CharbaJsPluginHelper.register=function $CharbaJsPluginHelper$register$($instance$$){Chart.registry.addPlugins([$instance$$])};CharbaJsPluginHelper.unregister=function $CharbaJsPluginHelper$unregister$($instance$$){Chart.registry.remove([$instance$$])};",
			...
			"CharbaJsControllerHelper.linkScales=function $CharbaJsControllerHelper$linkScales$($controllerType$$,$context$$){Chart.controllers[$controllerType$$].prototype.linkScales.call($context$$)};CharbaJsControllerHelper.buildOrUpdateElements=function $CharbaJsControllerHelper$buildOrUpdateElements$($controllerType$$,$context$$){Chart.controllers[$controllerType$$].prototype.buildOrUpdateElements.call($context$$)};function CharbaJsWindowHelper(){}",
			"CharbaJsWindowHelper.enableResizeOnBeforePrint=function $CharbaJsWindowHelper$enableResizeOnBeforePrint$(){window.onbeforeprint=function $window$onbeforeprint$($event$$){for(var $id$$ in Chart.instances)Chart.instances[$id$$].resize()}};function CharbaJsPositionerHelper(){}CharbaJsPositionerHelper.register=function $CharbaJsPositionerHelper$register$($name$$,$module$$){null!=$module$$&&\"function\"===typeof $module$$&&(Chart.registry.getPlugin(\"tooltip\").positioners[$name$$]=$module$$)};",
			"CharbaJsPositionerHelper.unregister=function $CharbaJsPositionerHelper$unregister$($name$$){var $tooltipPlugin$$=Chart.registry.getPlugin(\"tooltip\");\"undefined\"!=$tooltipPlugin$$.positioners[$name$$]&&delete $tooltipPlugin$$.positioners[$name$$]};",
