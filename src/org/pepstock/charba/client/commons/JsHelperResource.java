...
public final class JsHelperResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"CharbaJsPositionerHelper.invoke=function $CharbaJsPositionerHelper$invoke$($name$$,$context$$,$elements$$,$eventPoint$$){return\"undefined\"!=Chart.Tooltip.positioners[$name$$]?Chart.Tooltip.positioners[$name$$].apply($context$$,[$elements$$,$eventPoint$$]):null};function CharbaJsCallbacksHelper(){}",
