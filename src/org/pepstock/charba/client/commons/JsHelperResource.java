...
public final class JsHelperResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"CharbaJsCallbacksHelper.isTooltipCallbacksConsistent=function($key$$){return\"object\"===Chart.defaults.plugins.tooltip&&\"object\"===typeof Chart.defaults.plugins.tooltip.callbacks&&\"function\"===typeof Chart.defaults.plugins.tooltip.callbacks[$key$$]};CharbaJsCallbacksHelper.invokeDefaultTooltipsForElement=function($result$$,$items$$,$key$$){$result$$=Chart.defaults.plugins.tooltip.callbacks[$key$$].call($result$$,$items$$);return\"string\"===typeof $result$$?[$result$$]:$result$$};",
		"CharbaJsCallbacksHelper.invokeDefaultTooltipsForLabel=function($tooltipModel$$,$item$$,$key$$){return Chart.defaults.plugins.tooltip.callbacks[$key$$].call($tooltipModel$$,items)};CharbaJsCallbacksHelper.invokeDefaultTooltipsForLabelObject=function($tooltipModel$$,$item$$,$key$$){return Chart.defaults.plugins.tooltip.callbacks[$key$$].call($tooltipModel$$,$item$$)};function CharbaJsZoomHelper(){}",
		"CharbaJsZoomHelper.resetZoom=function($chart$$){null!=$chart$$&&\"function\"===typeof $chart$$.resetZoom&&$chart$$.resetZoom.call($chart$$)};function CharbaJsItemsHelper(){}CharbaJsItemsHelper.isCanvasPattern=function($obj$$,$key$$){return $obj$$[$key$$]instanceof CanvasPattern};CharbaJsItemsHelper.isCanvasGradient=function($obj$$,$key$$){return $obj$$[$key$$]instanceof CanvasGradient};CharbaJsItemsHelper.nativeEvent=function($obj$$,$key$$){return $obj$$[$key$$]};",
