 ...
 */
public class JsArrayStringImpl extends JsArrayString {

	/**
	 * Needed for GWT injection
	 */
	protected JsArrayStringImpl() {
		// do nothing
	}
	 ...
	 */
    public final native int lastIndexOf(String value) /*-{
     ...
     */
    public final native String remove(int index) /*-{
     ...
     */
    public final native void insertAt(int index, String value) /*-{
