...
/**
 * A java script property setter and getter of {@link Double}.
 * 
 * @author Andrea "Stock" Stocchero
 */
@JsType(isNative = true, name = NativeName.JS_OBJECT_DOUBLE_HELPER, namespace = JsPackage.GLOBAL)
final class NativeJsObjectDouble {

	/**
	 * To avoid any instantiation
	 */
	private NativeJsObjectDouble() {
		// do nothing
	}
	 ...
	 */
	static native double get(NativeObject target, String key);
	 ...
	 */
	static native void set(NativeObject target, String key, double value);
