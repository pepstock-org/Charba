...
public final class ArrayCanvas extends Array {

	/**
	 * This method creates new array instance with a variable number of <code>HTMLCanvasElement</code> arguments.
	 * 
	 * @param items HTMLCanvasElement items to create new array
	 * @return new array instance of canvas.
	 */
	private static native ArrayCanvas of(Canvas... items);
	...
	public static ArrayCanvas fromOrNull(List<Canvas> items) {
		...
		if (items instanceof ArrayCanvasList) {
			// casts to array list
			ArrayCanvasList list = (ArrayCanvasList) items;
			// returns array
	 ...
	 */
	@JsOverlay
	public static ArrayCanvas fromOrEmpty(List<Canvas> items) {
		// checks if is already a list with array
		if (items instanceof ArrayCanvasList) {
			// casts to array list
			ArrayCanvasList list = (ArrayCanvasList) items;
	 ...
	 */
	native ArrayCanvas slice(int start, int end);
	 ...
	 */
	native ArrayCanvas splice(int start);
	 ...
	 *         If no elements are removed, an empty array is returned.
	 */
	native ArrayCanvas splice(int start, int deleteCounts);
	 ...
	 *         If no elements are removed, an empty array is returned.
	 */
	native ArrayCanvas splice(int start, int deleteCounts, Canvas item);
	 ...
	 */
	@JsOverlay
	void insertAt(int index, Canvas item) {
		splice(index, 0, item);
	}
	 ...
	 */
	native void fill(Canvas item, int start, int end);
	 ...
	 */
	@JsOverlay
	void set(int index, Canvas item) {
