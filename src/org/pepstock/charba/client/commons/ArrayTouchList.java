 ...
 * This implementation uses a java script array as back-end to store objects (touch).
 * 
 * @author Andrea "Stock" Stocchero
 * @see org.pepstock.charba.client.commons.ArrayTouch
 */
public final class ArrayTouchList extends AbstractArrayList<Touch, ArrayTouch> {

	// delegated array to store objects
	private final ArrayTouch array;
	 ...
	 */
	ArrayTouchList(ArrayTouch array) {
		// if null, creates a new array
		if (array == null) {
			this.array = new ArrayTouch();
		} else {
	 ...
	 */
	@Override
	Touch checkAndGet(Object object) {
		// checks if touch
	...
	public boolean retainAll(Collection<?> collection) {
		...
		if (modified) {
			...
			List<Touch> contained = new ArrayList<>();
