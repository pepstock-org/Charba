 ...
 */
public class JsArrayIntegerImpl extends JsArrayInteger {

	/**
	 * Needed for GWT injection
	 */
	protected JsArrayIntegerImpl() {
		// do nothing
	}
	 ...
	 */
    public final native int lastIndexOf(int value) /*-{
     ...
     */
    public final native int remove(int index) /*-{
     ...
     */
    public final native void insertAt(int index, int value) /*-{
