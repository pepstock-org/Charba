...
abstract class AbstractChartTypedEvent extends AbstractChartEvent implements IsChartEvent {
	...
	private final List<DatasetReferenceItem> items;
	 ...
	 */
	AbstractChartTypedEvent(ChartEventContext eventContext, EventType type, Key key, List<DatasetReferenceItem> items) {
	 ...
	 */
	@Override
	public final List<DatasetReferenceItem> getItems() {
		return items;
	}
