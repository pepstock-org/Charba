...
public final class ChartHoverEvent extends AbstractChartTypedEvent {
	 ...
	 * @param items a list of items with dataset references related to the hover
	 */
	public ChartHoverEvent(ChartEventContext eventContext, List<DatasetReferenceItem> items) {
		super(eventContext, TYPE, ChartEventProperty.ON_HOVER, items);
	}
