...
public final class ChartPointerOptions extends AbstractCursorPointerOptions {
	...
	public ChartPointerOptions(IsChart chart) {
		this(IsChart.checkAndGetIfValid(chart).getId(), IsChart.isConsistent(chart) ? chart.getDefaultChartOptions().getPlugins().getOptions(ChartPointer.ID, ChartPointer.DEFAULTS_FACTORY) : null);
	}
	 ...
	 */
	ChartPointerOptions(String scope, ChartPointerDefaultsOptions defaultsOptions) {
	 ...
	 * @param defaultsOptions default options stored into defaults global
	 */
	ChartPointerOptions(String scope, ChartPointerDefaultsOptions defaultsOptions, NativeObject nativeObject) {
		super(ChartPointer.ID, scope, nativeObject);
