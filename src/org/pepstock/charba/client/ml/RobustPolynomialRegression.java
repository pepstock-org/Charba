 ...
 *
 */
public final class RobustPolynomialRegression extends BasePolynomialRegression<NativeRobustPolynomialRegression> {
	 ...
	 */
	RobustPolynomialRegression(RegressionDescriptor descriptor) {
		super(RegressionType.ROBUST_POLYNOMIAL, NativeRobustPolynomialRegression.load(descriptor));
	}
	 ...
	 */
	RobustPolynomialRegression(List<Double> x, List<Double> y, int degree) {
		super(RegressionType.ROBUST_POLYNOMIAL, new NativeRobustPolynomialRegression(ArrayDouble.fromOrEmpty(x), ArrayDouble.fromOrEmpty(y), degree));
	}
