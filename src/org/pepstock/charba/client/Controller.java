...
public interface Controller {
	 ...
	 * 
	 * @return <code>false</code> if the controller does not have to be registered because is a OUT-OF-THE-BOX controller (in javascript) and does not have to be transformed
	 */
