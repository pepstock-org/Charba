...
public class ArcElement extends ChartElement {
	 ...
	 */
	public static final ElementFactory<ArcElement> FACTORY = new ArcElementFactory();
	 ...
	 */
	protected ArcElement(CallbacksEnvelop<NativeObject> envelop) {
	 ...
	 * @author Andrea "Stock" Stocchero
	 */
	private static class ArcElementFactory implements ElementFactory<ArcElement> {
