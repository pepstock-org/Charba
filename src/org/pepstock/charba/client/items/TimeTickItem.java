 ...
 */
public final class TimeTickItem extends NativeObjectContainer {
	 ...
	 * 
	 * @return the date of the tick. Default is <code>null</code>.
	 */
	...
	/**
	 * Returns <code>true</code> if is the major tcik, otherwise <code>false</code>.
	 * 
	 * @return <code>true</code> if is the major tcik, otherwise <code>false</code>.
	 */
