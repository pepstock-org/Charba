 ...
 *
 */
public final class DeferredDateAdapterInjectionComplete implements DateAdapterInjectionComplete{
	// singleton instance
	private static final DeferredDateAdapterInjectionComplete INSTANCE = new DeferredDateAdapterInjectionComplete();

	/**
	 * To avoid any instantiation
	 */
	private DeferredDateAdapterInjectionComplete() {
		// do nothing
	}
	 ...
	 */
	static DeferredDateAdapterInjectionComplete get() {
		return INSTANCE;
	}
}
