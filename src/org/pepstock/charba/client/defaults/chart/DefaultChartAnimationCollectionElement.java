...
/**
 * Defaults for collection animation option element.
 * 
 * @author Andrea "Stock" Stocchero
 */
public class DefaultChartAnimationCollectionElement extends AbstractDefaultChartAnimation<IsDefaultAnimationCollectionElement> implements IsDefaultAnimationCollectionElement {
	 ...
	 */
	DefaultChartAnimationCollectionElement(IsDefaultAnimationCollectionElement animation) {
		super(animation);
	}
