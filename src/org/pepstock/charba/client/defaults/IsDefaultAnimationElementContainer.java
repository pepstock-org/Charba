...
/**
 * Interface to define animation object which can manage internal element.
 * 
 * @author Andrea "Stock" Stocchero
 */
public interface IsDefaultAnimationElementContainer extends IsDefaultBaseAnimation{
	 ...
	 */
	IsDefaultAnimationPropertyElement getProperty(IsAnimationProperty property);
	 ...
	 */
	IsDefaultAnimationCollectionElement getCollection(IsAnimationCollection collection);
