...
public final class Legend extends AbstractNode {
	...
	Legend(LegendAxisMapper mapper, NativeObject nativeObject) {
		...
		// sets function to proxy callback in order to invoke the java interface
		this.lengthCallbackProxy.setCallback(context -> ScriptableUtils.getOptionValue(new ScaleContext(mapper.getAxis(), context), getLengthCallback(), DEFAULT_LENGTH).intValue());
		// sets function to proxy callback in order to invoke the java interface
		this.widthCallbackProxy.setCallback(context -> ScriptableUtils.getOptionValue(new ScaleContext(mapper.getAxis(), context), getWidthCallback(), DEFAULT_WIDTH).intValue());
		// sets function to proxy callback in order to invoke the java interface
		this.indicatorWidthCallbackProxy.setCallback(context -> ScriptableUtils.getOptionValue(new ScaleContext(mapper.getAxis(), context), getIndicatorWidthCallback(), DEFAULT_INDICATOR_WIDTH).intValue());
		// sets function to proxy callback in order to invoke the java interface
