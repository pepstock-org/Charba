...
/**
 * The styling of the new element {@link ChoroplethBar} is based on {@link Bar} element with some additional options for the outline and graticule.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ChoroplethBar extends Bar implements HasCommonOptionsElement {
	 ...
	 */
	ChoroplethBar(Elements elements, Key childKey, IsDefaultBar defaultValues, NativeObject nativeObject) {
