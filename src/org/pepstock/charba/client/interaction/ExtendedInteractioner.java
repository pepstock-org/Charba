...
/**
 * Maps a custom interaction mode implementation which is already available and implemented in java script (for instance, controllers or plugins which added a specific interaction
 * mode).
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
final class ExtendedInteractioner extends AbstractNativeInteractioner<ExtendedInteraction> {
	 ...
	 */
	ExtendedInteractioner(String mode, ExtendedInteraction callback) {
		super(mode, callback);
	}
	 ...
	 */
	@Override
	final ArrayObject invoke(Chart chart, NativeObject event, NativeObject options, boolean useFinalPosition) {
