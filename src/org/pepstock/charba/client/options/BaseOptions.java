...
public abstract class BaseOptions extends EventProvider {
	...
	public double getDevicePixelRatio() {
		return getValue(Property.devicePixelRatio, getChart().getGlobal().getDevicePixelRatio());
	}
	 ...
	 * @param metadata dataset meta data.
	 */
	protected void onClick(ChartNativeEvent event, GenericJavaScriptObject metadata) {
	 ...
	 */
	protected void onResize(GenericJavaScriptObject item) {
		NativeEvent event = Document.get().createChangeEvent();
		getChart().fireEvent(new ChartResizeEvent(event, new SizeItem(item)));
	}
