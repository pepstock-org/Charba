...
/**
 * The grid line configuration defines options for the grid lines that run
...
public class GridLines extends JavaScriptObjectContainer {
	 ...
	 * If false, do not display grid lines for this axis.
	 * 
	 * @return If false, do not display grid lines for this axis. Default is
	 *         true.
	 */
	 ...
	 * 
	 * @param color
	 *            The color of the grid lines. If specified as an array, the
	 *            first color applies to the first grid line, the second to the
	 ...
	 * on.
	 * 
	 * @return the list of colors of the grid lines. If not set, default is only
	 ...
	 * values which specify alternating lengths of lines and gaps which describe
	 * the pattern.
	 * 
	 * @param borderDash
	...
	/**
	 * Returns the line dash pattern used when stroking lines, using an array of
	 * values which specify alternating lengths of lines and gaps which describe
	 * the pattern.
	 * 
	 ...
	 * 
	 * @param drawBorder
	 *            If true, draw border at the edge between the axis and the
	 *            chart area.
	 */
	 ...
	 * If true, draw border at the edge between the axis and the chart area.
	 * 
	 * @return If true, draw border at the edge between the axis and the chart
	 *         area. If not set, default is true
	 */
	 ...
	 * lines are drawn.
	 * 
	 * @return If true, draw lines on the chart area inside the axis lines. This
	 *         is useful when there are multiple axes and you need to control
	 *         which grid lines are drawn. If not set, default is true
	 */
	 ...
	 * 
	 * @param drawTicks
	 *            If true, draw lines beside the ticks in the axis area beside
	 *            the chart.
	 */
	 ...
	 * If true, draw lines beside the ticks in the axis area beside the chart.
	 * 
	 * @return If true, draw lines beside the ticks in the axis area beside the
	 *         chart. If not set, default is true
	 */
	...
	/**
	 * Sets the length in pixels that the grid lines will draw into the axis
	 * area.
	 * 
	 * @param tickMarkLength
	 *            Length in pixels that the grid lines will draw into the axis
	 *            area.
	 */
	...
	/**
	 * Returns the length in pixels that the grid lines will draw into the axis
	 * area.
	 * 
	 * @return Length in pixels that the grid lines will draw into the axis
	 *         area. If not set, default is 10
	 */
	 ...
	 * 
	 * @return Stroke width of the grid line for the first index (index 0). If
	 *         not set, default is 1
	 */
	 ...
	 * 
	 * @return Stroke color of the grid line for the first index (index 0). If
	 *         not set, default is 'rgba(0, 0, 0, 0.25)'
	 */
	...
	/**
	 * Sets the length and spacing of dashes of the grid line for the first
	 * index (index 0).
	 * 
	 * @param zeroLineBorderDash
	...
	/**
	 * Returns the length and spacing of dashes of the grid line for the first
	 * index (index 0).
	 * 
	 * @return the length and spacing of dashes of the grid line for the first
	 *         index (index 0).
	 */
	...
	/**
	 * Sets the offset for line dashes of the grid line for the first index
	 * (index 0).
	 * 
	 * @param zeroLineBorderDashOffset
	 *            the offset for line dashes of the grid line for the first
	 *            index (index 0).
	 */
	...
	/**
	 * Returns the offset for line dashes of the grid line for the first index
	 * (index 0).
	 * 
	 * @return the offset for line dashes of the grid line for the first index
	 *         (index 0). if not set, default is 0
	 */
	 ...
	 * true in the bar chart by default.
	 * 
	 * @param offsetGridLines
	 ...
	 * true in the bar chart by default.
	 * 
	 * @return If true, grid lines will be shifted to be between labels. If not
