...
final class ToastJsUtilResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"$options$$.progressBarType&&($cssAnimation_icon_progressBar_text$$10_title$$.classList+=\" \"+$options$$.progressBarType);$event_wrapper$$.appendChild($cssAnimation_icon_progressBar_text$$10_title$$)}\"function\"===typeof $options$$.onClick&&$toasting$$.addEventListener(\"click\",function($event$$){return $options$$.onClick.apply($$jscomp$this$$,[$result$$,$event$$])});$result$$.showing=!0;$toasting$$.hide=function $$toasting$$$hide$(){$toasting$$.className+=\" ct-fadeOut\";$toasting$$.addEventListener(\"animationend\",",
		"$removeToast$$,!1);return null};$options$$.autoHide&&setTimeout($toasting$$.hide,$options$$.timeout+200);$event_wrapper$$.className=$options$$.type?$event_wrapper$$.className+(\" ct-\"+$options$$.type):$event_wrapper$$.className+\" ct-default\";$toasting$$.addEventListener(\"click\",$toasting$$.hide);$toasting$$.appendChild($event_wrapper$$);document.getElementById(\"ct-container\").appendChild($toasting$$);$result$$.id=$pId$$;$result$$.dateTime=Date.now();$result$$.element=$toasting$$;\"function\"===typeof $options$$.onOpen&&",
		"($event_wrapper$$=new Event(\"toast-open\"),$options$$.onOpen.apply(this,[$result$$,$event_wrapper$$]));return $result$$}},create:function $CharbaToast$create$(){console.error(\"DOM has not finished loading.\\n\\tInvoke create method when DOMs readyState is complete\")},defaults:{autoHide:!0,borderRadius:8,hideProgressBar:!1,icon:void 0,onClick:void 0,onClose:void 0,onOpen:void 0,progressBarType:void 0,title:\"Default title\",text:void 0,timeout:4E3,type:void 0},overrides:{}};Object.freeze(CharbaToast.defaults);",
