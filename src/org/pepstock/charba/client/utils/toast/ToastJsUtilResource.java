...
final class ToastJsUtilResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"$removeToast$$,!1);return null};$options$$.autoHide&&setTimeout($toasting$$.hide,$options$$.timeout+200);$wrapper$$.className=$options$$.type?$wrapper$$.className+(\" ct-\"+$options$$.type):$wrapper$$.className+\" ct-default\";$toasting$$.addEventListener(\"click\",$toasting$$.hide);$toasting$$.appendChild($wrapper$$);document.getElementById(\"ct-container\").appendChild($toasting$$);$result$$.id=$pId$$;$result$$.dateTime=Date.now();$result$$.element=$toasting$$;\"function\"===typeof $options$$.onOpen&&$options$$.onOpen.apply(this,",
		"[$result$$]);return $result$$}},create:function $CharbaToast$create$(){console.error(\"DOM has not finished loading.\\n\\tInvoke create method when DOMs readyState is complete\")},defaults:{autoHide:!0,borderRadius:8,hideProgressBar:!1,icon:void 0,onClick:void 0,onClose:void 0,onOpen:void 0,progressBarType:void 0,title:\"Default title\",text:void 0,timeout:4E3,type:void 0},overrides:{}};Object.freeze(CharbaToast.defaults);",
