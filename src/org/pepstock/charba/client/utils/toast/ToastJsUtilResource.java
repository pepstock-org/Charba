...
final class ToastJsUtilResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"[$result$$])}var $$jscomp$this$$=this,$result$$=Object.assign({},$pOptions$$||{}),$options$$=Object.assign({},CharbaToast.defaults,CharbaToast.overrides,$result$$),$font$0_hasTitle_normFont$1_rules_title$$=\"string\"===typeof $options$$.title.content,$cssAnimation_hasLabel_icon_progressBar_text$$=Array.isArray($options$$.label.content)&&0<$options$$.label.content.length;if(!$font$0_hasTitle_normFont$1_rules_title$$&&!$cssAnimation_hasLabel_icon_progressBar_text$$)return null;var $toasting$$=document.createElement(\"div\");",
		"$toasting$$.id=\"toast-\"+$pId$$;$toasting$$.className=\"ct-toast\";var $wrapper$$=document.createElement(\"div\");$wrapper$$.style.borderRadius=$options$$.borderRadius+\"px\";$options$$.hideShadow&&($wrapper$$.style.boxShadow=\"none\");if($font$0_hasTitle_normFont$1_rules_title$$){$font$0_hasTitle_normFont$1_rules_title$$=document.createElement(\"h4\");$font$0_hasTitle_normFont$1_rules_title$$.className=\"ct-title\";$font$0_hasTitle_normFont$1_rules_title$$.innerHTML=$options$$.title.content;\"string\"===typeof $options$$.title.color&&",
		"($font$0_hasTitle_normFont$1_rules_title$$.style.color=$options$$.title.color);if(\"object\"===typeof $options$$.title.font){var $font$$=Object.assign({},CharbaToast.defaults.titleFont,$options$$.title.font),$font$$=CharbaToast.helper.toFont.apply(this,[$font$$]);$font$0_hasTitle_normFont$1_rules_title$$.style.font=$font$$.string}$wrapper$$.appendChild($font$0_hasTitle_normFont$1_rules_title$$)}$cssAnimation_hasLabel_icon_progressBar_text$$&&($cssAnimation_hasLabel_icon_progressBar_text$$=document.createElement(\"p\"),",
		"$cssAnimation_hasLabel_icon_progressBar_text$$.className=\"ct-text\",$cssAnimation_hasLabel_icon_progressBar_text$$.innerHTML=$options$$.label.content.join(\"<br/>\"),\"string\"===typeof $options$$.label.color&&($cssAnimation_hasLabel_icon_progressBar_text$$.style.color=$options$$.label.color),\"object\"===typeof $options$$.label.font&&($font$0_hasTitle_normFont$1_rules_title$$=Object.assign({},CharbaToast.defaults.labelFont,$options$$.label.font),$font$0_hasTitle_normFont$1_rules_title$$=CharbaToast.helper.toFont.apply(this,",
		"[$font$0_hasTitle_normFont$1_rules_title$$]),$cssAnimation_hasLabel_icon_progressBar_text$$.style.font=$font$0_hasTitle_normFont$1_rules_title$$.string),$wrapper$$.appendChild($cssAnimation_hasLabel_icon_progressBar_text$$));$options$$.icon&&$options$$.icon.src&&($wrapper$$.classList+=\" img\",$cssAnimation_hasLabel_icon_progressBar_text$$=document.createElement(\"img\"),$cssAnimation_hasLabel_icon_progressBar_text$$.src=$options$$.icon.src,$cssAnimation_hasLabel_icon_progressBar_text$$.className=\"ct-icon\",",
		"$wrapper$$.appendChild($cssAnimation_hasLabel_icon_progressBar_text$$));$options$$.hideProgressBar||($cssAnimation_hasLabel_icon_progressBar_text$$=document.createElement(\"style\"),$cssAnimation_hasLabel_icon_progressBar_text$$.id=\"style-\"+$toasting$$.id,$cssAnimation_hasLabel_icon_progressBar_text$$.type=\"text/css\",$font$0_hasTitle_normFont$1_rules_title$$=document.createTextNode(\"\\n            @keyframes animate-\"+$pId$$+\" {\\n              0% {\\n                width: 100%\\n              }\\n              100% {\\n                width: 0%;\\n              }\\n            }\\n        \"),",
		...
		"defaults:{autoHide:!0,borderRadius:8,hideProgressBar:!1,hideShadow:!1,icon:void 0,onClick:void 0,onClose:void 0,onOpen:void 0,progressBarType:void 0,title:{content:void 0,color:void 0,font:void 0},label:{content:void 0,color:void 0,font:void 0},timeout:4E3,type:void 0,titleFont:{family:'system-ui, -apple-system, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\"',lineHeight:1.2,size:15,style:\"normal\",weight:\"bold\"},labelFont:{family:'system-ui, -apple-system, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\"',",
