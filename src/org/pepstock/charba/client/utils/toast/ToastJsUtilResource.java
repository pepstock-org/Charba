...
final class ToastJsUtilResource extends AbstractInjectableResource {
	...
	private static final String[] CONTENT = {
		...
		"lineHeight:\"20px\",size:14,style:\"normal\",weight:\"normal\"}},overrides:{},onClose:void 0};Object.freeze(CharbaToast.defaults);Object.freeze(CharbaToast.helper);\"complete\"===document.readyState?CharbaToast.init():window.addEventListener(\"DOMContentLoaded\",CharbaToast.init);"
	};
