...
/**
 * Base object to enable the {@link AxisBuildTicksCallback} on an axis, {@link CartesianLinearAxis} or {@link CartesianLogarithmicAxis} or {@link RadialAxis}, when the ticks are
...
final class LinearAxisBuildTicksCallbackHandler extends AbstractAxisBuildTicksCallbackHandler<AxisBuildTicksCallback> {
	...
	interface ProxyAxisCallback {
		 ...
		 */
		void call(CallbackFunctionContext context, NativeObject item, ArrayDouble tickItems);
	}
	 ...
	 * @param tickItems list of created ticks
	 */
