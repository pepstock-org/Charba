 ...
 *
 */
final class CategoryAxisBuildTicksCallbackHandler extends AbstractAxisBuildTicksCallbackHandler<CategoryAxisBuildTicksCallback> {
	 ...
	 */
	CategoryAxisBuildTicksCallbackHandler(CartesianCategoryAxis axis) {
		super(axis);
		// -------------------------------
