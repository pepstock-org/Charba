...
/**
 * Callback interface of {@link AnnotationPlugin#ID} plugin that is called once mousedown is fired.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public interface MouseDownCallback {
	 ...
	 */
	void onMouseDown(IsChart chart, BaseNativeEvent event, AbstractAnnotation annotation);
