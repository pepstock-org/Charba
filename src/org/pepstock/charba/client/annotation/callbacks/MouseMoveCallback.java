...
/**
 * Callback interface of {@link AnnotationPlugin#ID} plugin that is called once mousemove is fired.
 * 
...
public interface MouseMoveCallback {
	 ...
	 */
	void onMouseMove(IsChart chart, BaseNativeEvent event, AbstractAnnotation annotation);
