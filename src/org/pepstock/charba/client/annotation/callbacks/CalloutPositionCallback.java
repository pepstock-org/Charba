...
/**
 * Callback interface of {@link AnnotationPlugin#ID} plugin to set <code>position</code> property at runtime, to {@link Callout}.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public interface CalloutPositionCallback extends Scriptable<CalloutPosition, AnnotationContext> {
