...
/**
 * Callback interface to set <code>margin</code> property at runtime in {@link Callout} item.
 * 
 * @author Andrea "Stock" Stocchero
 * 
 */
public interface MarginCallback extends Scriptable<Integer, AnnotationContext> {
