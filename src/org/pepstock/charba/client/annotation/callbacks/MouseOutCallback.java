...
/**
 * Callback interface of {@link AnnotationPlugin#ID} plugin that is called once mouseout is fired.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public interface MouseOutCallback {
	 ...
	 */
	void onMouseOut(IsChart chart, BaseNativeEvent event, AbstractAnnotation annotation);
