...
/**
 * Callback interface of {@link AnnotationPlugin#ID} plugin that is called once wheel is fired.
 * 
...
public interface WheelCallback {
	 ...
	 */
	void onWheel(IsChart chart, NativeEvent event, AbstractAnnotation annotation);
