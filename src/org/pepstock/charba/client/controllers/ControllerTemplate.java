...
final class ControllerTemplate {
	...
	private static final String[] CONTENT = {
		"function Charba{0}(){Chart.controllers.{1}.apply(this,arguments)}Charba{0}.prototype=Object.create(Chart.controllers.{1}.prototype);Charba{0}.prototype.constructor=Charba{0};Charba{0}.cloneDefaults={2};",
		"Charba{0}.prototype.checkAndGetWrapper=function($property$$){var $delegated$$=CharbaJsControllerHelper.wrappers.{0};return\"undefined\"!==typeof $delegated$$&&\"function\"===typeof $delegated$$[$property$$]?$delegated$$:null};Charba{0}.prototype.initialize=function(){var $delegated$$=this.checkAndGetWrapper(\"initialize\");null!==$delegated$$?$delegated$$.initialize.apply(this,arguments):Chart.controllers.{1}.prototype.initialize.apply(this,arguments)};",
		"Charba{0}.prototype.addElements=function(){var $delegated$$=this.checkAndGetWrapper(\"addElements\");null!==$delegated$$?$delegated$$.addElements.apply(this,arguments):Chart.controllers.{1}.prototype.addElements.apply(this,arguments)};Charba{0}.prototype.draw=function(){var $delegated$$=this.checkAndGetWrapper(\"draw\");null!==$delegated$$?$delegated$$.draw.apply(this,arguments):Chart.controllers.{1}.prototype.draw.apply(this,arguments)};",
		"Charba{0}.prototype.removeHoverStyle=function(){var $delegated$$=this.checkAndGetWrapper(\"removeHoverStyle\");null!==$delegated$$?$delegated$$.removeHoverStyle.apply(this,arguments):Chart.controllers.{1}.prototype.removeHoverStyle.apply(this,arguments)};",
