...
/**
 * Callback interface to set <code>fill</code> property at runtime, using the chart instance and the context.
 * 
 ...
 */
public interface FillCallback extends Scriptable<Object> {
