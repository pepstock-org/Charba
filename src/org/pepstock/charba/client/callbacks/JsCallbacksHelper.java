...
/**
 * This is a singleton wrapper for Java native object which is wrapping a CHARBA java script object implementation with some utilities to manage native scriptable options context.
 * 
...
final class JsCallbacksHelper {
	 ...
	 */
	NativeContext wrap(NativeObject object) {
		return NativeJsCallbacksHelper.wrap(object);
	}
}
