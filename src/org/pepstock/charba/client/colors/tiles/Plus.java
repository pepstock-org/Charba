...
/**
 * PLUS drawer to design a plus in the tile.<br>
 * It designs a plus in the the following tile sections (A and B):<br>
 * <br>
 * 
 * <pre>
 * +---------+---------+
...
final class Plus extends ShapeDrawer {
	 ...
	 */
	void drawPlus(Context2dItem context, int size, double offsetX, double offsetY) {
		// calculates half dimension
		final double halfSize = size / 2D;
