...
/**
 * BOX drawer to design a box into tile.<br>
 * It designs a box into the following tile sections (A and B):<br>
 * <br>
 * 
 * <pre>
 * +---------+---------+
 ...
 *
 */
final class Box extends ShapeDrawer {
	...
	/**
	 * Designs a box into a tile section.
	 * 
	 ...
	 */
	void drawBox(Context2dItem context, int size, double offsetX, double offsetY) {
		// calculates half dimension
		final double halfSize = size / 2D;
		// calculates margin from boundary of tile
		final double margin = size / 20D;
		// multiply by 4 because the margin is applied to all sides
		final double wholeMargin = margin * 4D;
		// draws shape
