...
enum ResourceHash {
	 ...
	 */
	ANNOTATION_PLUGIN_RESOURCE(ResourceName.ANNOTATION_PLUGIN, 2610800),
	/**
	 ...
	 */
	GEO_CONTROLLER_RESOURCE(ResourceName.GEO_CONTROLLER, 7571908),
	/**
	 ...
	 */
	JS_HELPER_RESOURCE(ResourceName.CHARBA_HELPER, 1028192),
	/**
	 ...
	 */
	MATRIX_CONTROLLER_RESOURCE(ResourceName.MATRIX_CONTROLLER, 312819),
	/**
	 ...
	 */
	SANKEY_CONTROLLER_RESOURCE(ResourceName.SANKEY_CONTROLLER, 925940),
	/**
	 ...
	 */
	TREE_MAP_CONTROLLER_RESOURCE(ResourceName.TREEMAP_CONTROLLER, 1193822),
	/**
