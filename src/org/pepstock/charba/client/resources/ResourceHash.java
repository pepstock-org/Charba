...
enum ResourceHash {
	 ...
	 */
	CHART_JS_RESOURCE(ResourceName.CHART, 17756880),
	/**
	 ...
	 */
	GEO_CONTROLLER_RESOURCE(ResourceName.GEO_CONTROLLER, 9077257),
	/**
	 ...
	 */
	LUXON_LIBRARY_RESOURCE(ResourceName.DATE_TIME_LIBRARY, 15881852),
	/**
