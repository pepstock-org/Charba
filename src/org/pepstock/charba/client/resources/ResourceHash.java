...
enum ResourceHash {
	 ...
	 */
	ANNOTATION_PLUGIN_RESOURCE(ResourceName.ANNOTATION_PLUGIN, 1300903),
	/**
	 * Hash item for 'ChartJsResource' class.
	 */
	CHART_JS_RESOURCE(ResourceName.CHART, 17447666),
	/**
	 ...
	 */
	LUXON_LIBRARY_RESOURCE(ResourceName.DATE_TIME_LIBRARY, 15779113),
	/**
	 ...
	 */
	TREE_MAP_CONTROLLER_RESOURCE(ResourceName.TREEMAP_CONTROLLER, 974921),
	/**
