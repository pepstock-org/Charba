...
enum ResourceHash {
	 ...
	 */
	ANNOTATION_PLUGIN_RESOURCE(ResourceName.ANNOTATION_PLUGIN, 2611300),
	/**
	 * Hash item for 'ChartJsResource' class.
	 */
	CHART_JS_RESOURCE(ResourceName.CHART, 18269369),
	/**
	 ...
	 */
	GEO_CONTROLLER_RESOURCE(ResourceName.GEO_CONTROLLER, 7578838),
	/**
	 ...
	 */
	JS_HELPER_RESOURCE(ResourceName.CHARBA_HELPER, 1046145),
	/**
