...
enum ResourceHash {
	 ...
	 */
	ANNOTATION_PLUGIN_RESOURCE(ResourceName.ANNOTATION_PLUGIN, 3063920),
	/**
	 * Hash item for 'ChartJsResource' class.
	 */
	CHART_JS_RESOURCE(ResourceName.CHART, 18297547),
	/**
	 ...
	 */
	JS_HELPER_RESOURCE(ResourceName.CHARBA_HELPER, 1084086),
	/**
	 ...
	 */
	MATRIX_CONTROLLER_RESOURCE(ResourceName.MATRIX_CONTROLLER, 324969),
	/**
