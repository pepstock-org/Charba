...
enum ResourceHash {
	 ...
	 */
	CHART_JS_RESOURCE(ResourceName.CHART, 17725193),
	/**
	 ...
	 */
	GEO_CONTROLLER_RESOURCE(ResourceName.GEO_CONTROLLER, 9027932),
	/**
	 ...
	 */
	JS_HELPER_RESOURCE(ResourceName.CHARBA_HELPER, 933679),
	/**
	 ...
	 */
	LUXON_LIBRARY_RESOURCE(ResourceName.DATE_TIME_LIBRARY, 15888453),
	/**
