 ...
 * @since 2.0
 * @see org.pepstock.charba.client.jsinterop.commons.ArrayInteger
 */
public final class ArrayIntegerList implements List<Integer> {
	...
	public String toString() {
		return "IntegerArrayList [array=" + JSON.stringify(array) + "]";
	}
