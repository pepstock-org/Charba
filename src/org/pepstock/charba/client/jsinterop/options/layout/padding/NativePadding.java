...
public final class NativePadding extends NativeObject {
	 ...
	 */
	@JsProperty
	public native void setLeft(int padding);
	 ...
	 */
	@JsProperty
	public native void setRight(int padding);
	 ...
	 */
	@JsProperty
	public native void setTop(int padding);
	 ...
	 */
	@JsProperty
	public native void setBottom(int padding);
