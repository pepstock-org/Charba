...
public final class NativeLegendLabels extends NativeFontItem {
	 ...
	 */
	@JsProperty
	public native void setUsePointStyle(boolean usePointStyle);
	 ...
	 */
	@JsProperty
	public native boolean isUsePointStyle();
	 ...
	 */
	@JsProperty
	public native void setBoxWidth(int boxWidth);
