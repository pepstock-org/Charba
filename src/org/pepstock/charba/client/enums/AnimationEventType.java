 ...
 *
 */
public enum AnimationEventType implements IsEvent
{
	/**
	 * Triggers during animation progress.
	 */
	PROGRESS("charbaAnimationProgress"),
	/**
	 * Triggers when the animation is completed.
	 */
	COMPLETED("charbaAnimationCompleted");
	 ...
	 */
	private AnimationEventType(String value) {
		this.value = value;
	}
